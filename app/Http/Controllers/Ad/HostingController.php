...
class HostingController extends Controller
{
    ...
    public function store(StoreHostingRequest $request)
    {
        ...
        $this->saveFile($request->file('images')[0], 'hostings', 'photo', '0_' . $hosting->id, $time, [400, 300]);
        $this->saveFile($request->file('images')[0], 'hostings', 'photo', '0_' . $hosting->id, $time, [224, 168]);
