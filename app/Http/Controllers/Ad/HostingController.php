...
class HostingController extends Controller
{
    ...
    public function store(StoreHostingRequest $request)
    {
        ...
        $this->saveFile($request->file('images')[0], 'hostings', 'photo', $hosting->id, $time, [400, 300], $user->name);
        $this->saveFile($request->file('images')[0], 'hostings', 'photo', $hosting->id, $time, [224, 168], $user->name);
