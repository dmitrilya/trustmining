...
trait AdTrait
{
    ...
    {
        $ads = Ad::with(['adCategory:name', 'user:id,name,url_name,tf', 'user.company:id', 'user.contacts.contactType', 'office:id,address', 'asicVersion:id,asic_model_id,hashrate', 'asicVersion.asicModel:id,name,algorithm_id', 'asicVersion.asicModel.algorithm:id,measurement']);
