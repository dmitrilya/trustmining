    ...
    public function checkDocument($text)
    {
        $params = [
            ...
            "messages" => [
                [
                    "role" => "system",
                    "text" => 'Представлен договор на оказание услуг. Нужно внимательно пройтись по всем пунктам договора и найти все риски для заказчика. 1) То что может повлечь за собой утрату оборудования заказчиком или другие материальные или финансовые потери, 2) Неточности описания условий договора которые могут привести к спорам, 3) Наличие ошибок в тексте или отклонение от стандартов составления договоров. Ответ предоставь в формате: Массив с тремя массивами по каждому пункту выше без ключей. В каждом массиве замечания в формате {"point": "Номер пункта договора", "problem": "Проблема"}]'
                ],
                [
                    "role" => "user",
                    "text" => $text
