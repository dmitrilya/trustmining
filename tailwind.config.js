...
module.exports = {
    ...
    safelist: [
        ...
        'from-red-800/40', 'to-red-900/20', 'dark:to-slate-900', 'border-red-500/60', 'bg-red-500', 'from-amber-800/40', 'to-amber-900/10', 'border-amber-500/50', 'bg-amber-500', 'from-indigo-800/40', 'to-indigo-900/10', 'border-indigo-500/50'
    ],
    darkMode: 'class',
    theme: {
        extend: {
