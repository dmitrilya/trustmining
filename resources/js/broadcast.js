...
window.messagesChannelEvent = function (e) {
    ...
    if (messagesList && messagesList.getAttribute('data-chat_id') == e.chat_id) {
        ...
        <div
            class="flex flex-col w-full max-w-[400px] leading-1.5 px-3 py-2 border-gray-300 dark:border-zinc-700 bg-white/60 dark:bg-zinc-900/60 rounded-b-xl mr-6 rounded-tr-xl">
        ...
        if (e.images.length) {
            ...
            <div class="flex flex-col w-full max-w-[400px] leading-1.5 px-3 py-2 border-gray-300 dark:border-zinc-700 bg-white/60 dark:bg-zinc-900/60 rounded-b-xl mr-6 rounded-tr-xl">
                <div class="flex items-center space-x-2 rtl:space-x-reverse mb-2">
                    <span class="text-xs text-gray-600">${date}</span>
                </div>
