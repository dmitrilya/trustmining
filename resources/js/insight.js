...
window.toc = (article, name) => {
    ...
    tocLgContainer.classList.add('sticky', 'top-6', 'p-4', 'bg-white/40', 'dark:bg-slate-900/40', 'border', 'border-slate-300', 'dark:border-slate-700', 'shadow-sm', 'shadow-logo-color', 'rounded-xl');
