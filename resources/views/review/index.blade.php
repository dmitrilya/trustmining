        ...
        <div class="w-full bg-white shadow-sm rounded-lg lg:rounded-l-none flex flex-col p-1 sm:p-4">
            ...
            @auth
                @if ($auth->id != $id && !$reviews->where('user_id', $auth->id)->count())
                    <form x-data="{
                        ...
                        <div
                            class="w-full border border-gray-200 rounded-b-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            @else
                <div class="flex flex-col items-center justify-center py-6">
                    <p class="text-gray-400 text-sm mb-4">{{ __('You must be logged in to leave a review.') }}</p>
