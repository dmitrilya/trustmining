<div
    ...
    <div>
        ...
        <div class="flex items-center mt-4 sm:mt-5">
            <div
                class="trust mr-1 sm:mr-2 size-3 md:size-4 rounded-full border border-gray-300 dark:border-zinc-700 {{ $shop->tf > config('trustfactor.yellow') ? ($ad->user->tf > config('trustfactor.green') ? 'bg-green-500' : 'bg-yellow-300') : 'bg-red-600' }}">
            </div>
