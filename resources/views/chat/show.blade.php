                        ...
                        <a href="{{ route('chat', ['chat' => $chat->id]) }}" id="chat-{{ $chat->id }}"
                            ...
                            <li>
                                ...
                                <div class="flex">
                                    ...
                                    <p class="w-full text-xs font-semibold text-slate-800 dark:text-slate-200">{{ $user->name }}</p>
