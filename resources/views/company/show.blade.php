<x-app-layout title="{{ $company->name }}: информация о компании"
    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 md:px-8 py-8">
        ...
        @if (isset($moderation))
            ...
            <div
                class="bg-white/40 dark:bg-slate-900/40 border border-slate-300 dark:border-slate-700 overflow-hidden shadow-sm shadow-logo-color rounded-xl p-2 sm:p-4 md:p-6 lg:p-8 xl:p-10 mb-2 sm:mb-4">
                    ...
                    <div class="md:col-span-4 space-y-5">
                        ...
                        <div class="my-5">
                            <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
                                ...
                                <li class="text-slate-500">{{ __('OGRN') . ': ' }}<span
                                        class="text-slate-800 dark:text-slate-200">{{ $company->card['ogrn'] }}</span>
                                </li>
