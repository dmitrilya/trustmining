        ...
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow rounded-lg">
            <form method="post" action="{{ route('company.update') }}" class="mt-6 space-y-6" enctype=multipart/form-data>
                ...
                <div>
                    ...
                    <x-text-input id="company" class="mt-1 block w-full" readonly disabled autocomplete="company" value="{{ $company->card['inn'] }}" />
                </div>
                ...
                <div>
                    ...
                    <x-file-input id="images" name="images[]" class="mt-1 block w-full" :value="old('images')"
                        ...
                        @change="if ($el.files.length > 3) {$el.value=null;return pushToastAlert('{{ __('validation.max.array', ['max' => 8]) }}', 'error')}" />
                ...
                <div>
                    ...
                    <textarea id="description" rows="16" name="description"
                        ...
                        required maxlength="1500" :value="old('description')"></textarea>
