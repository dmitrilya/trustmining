    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 items-start gap-2">
            <div class="xl:col-span-2 grid sm:grid-cols-2 gap-2">
                <div class="sm:col-span-2 p-3 sm:p-4 bg-white/60 dark:bg-zinc-900/60 shadow rounded-lg">
                    @include('profile.partials.ads')
                </div>

                <div
                    class="{{ !$user->passport && (!$user->company || $user->company->moderation) ? 'sm:col-span-2' : 'order-last' }} p-3 sm:p-4 bg-white/60 dark:bg-zinc-900/60 shadow rounded-lg">
                    @include('profile.partials.passport')
                </div>

                <div class="p-3 sm:p-4 bg-white/60 dark:bg-zinc-900/60 shadow rounded-lg">
            ...
            <div class="xl:col-span-3 grid sm:grid-cols-2 gap-2">
                ...
                <div class="sm:col-span-2 grid sm:grid-cols-2 gap-2">
                    ...
                    <div>
                        ...
                        {{-- <div class="mt-2 p-3 sm:p-4 bg-white/60 dark:bg-zinc-900/60 shadow rounded-lg">
