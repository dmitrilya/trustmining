        ...
        <div class="flex justify-between">
            ...
            @if ($user->company && !$user->company->moderation)
                <a href="{{ route('company.edit', ['company' => $user->company->id]) }}"
                    class="min-w-7 h-7 rounded-full shadow-lg shadow-logo-color bg-secondary-gradient opacity-70 hover:opacity-100 hover:shadow-xl shadow-logo-color text-white text-3xl flex items-center justify-center">
