<div
    class="relative sm:max-w-md h-full bg-white shadow-md overflow-hidden rounded-lg flex flex-col justify-between">
    <div>
    ...
    <div class="p-2 md:p-3">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                ...
                <p class="text-xxs sm:text-xs font-normal text-gray-400 ml-2">{{ $article->views()->count() }}</p>
            </div>
        </div>
