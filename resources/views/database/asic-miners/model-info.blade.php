<div itemscope itemtype="https://schema.org/Product"
    ...
    x-data={} x-init="addView('asic-model', {{ $model->id }})">
        ...
        <div class="md:col-span-2 md:border-r border-slate-300 dark:border-slate-700 md:pr-8">
            ...
            <div class="flex justify-between">
                ...
                <div
                    ...
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-indigo-500" aria-hidden="true" width="24" height="24" fill="none"
                        viewBox="0 0 24 24">
        ...
        <div class="mt-6 md:mt-0">
            ...
            <div class="flex flex-col mt-4 sm:mt-6 lg:mt-8">
                ...
                <x-buttons.secondary-button class="w-full justify-center" @click="{{ $trackClick }}">
                    <svg class="min-w-4 h-4 mr-1 xs:mr-2" aria-hidden="true" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            d="M4 4.5V19a1 1 0 0 0 1 1h15M7 10l4 4 4-4 5 5m0 0h-3.207M20 15v-3.207" />
                    </svg>
                ...
                <div itemprop="offers" itemscope itemtype="https://schema.org/AggregateOffer">
                    ...
                    <link itemprop="url" href="{{ route('ads', ['adCategory' => 'miners', 'model' => $model->slug]) }}" />
                </div>

                <a href="{{ route('ads', ['adCategory' => 'miners']) }}">
                    <x-buttons.primary-button class="w-full mt-2">{{ __('View all ads') }}</x-buttons.primary-button>
                </a>
            </div>
        </div>
    </div>
