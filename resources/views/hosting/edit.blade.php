            ...
            <form method="post" id="ad-update" action="{{ route('hosting.update', ['hosting' => $hosting->id]) }}"
                ...
                <div>
                    ...
                    <x-text-input id="video" name="video" type="text" class="mt-1 block w-full"
                        :value="$hosting->video" autocomplete="video" />
                    <x-input-error :messages="$errors->get('video')" class="mt-2" />
                </div>

                <x-peculiarities :ps="$hosting->peculiarities" :isForm="true"></x-peculiarities>
                ...
                <div>
                    ...
                    <x-text-input id="conditions" name="conditions" type="text" class="mt-1 block w-full"
                        :value="implode(';', $hosting->conditions)" autocomplete="conditions" />
                ...
                <div>
                    ...
                    <x-text-input id="expenses" name="expenses" type="text" class="mt-1 block w-full"
                        :value="implode(';', $hosting->expenses)" autocomplete="expenses" />
                ...
                <div>
                    ...
                    <textarea id="description" rows="16" name="description"
                        ...
                        required maxlength="1500" :value="$hosting - > description">{{ $hosting->description }}</textarea>
                ...
                <div>
                    ...
                    <x-text-input id="price" name="price" class="mt-1 block w-full" required autocomplete="price"
                        min="1" max="10" type="number" step="0.01" :value="$hosting->price" />
