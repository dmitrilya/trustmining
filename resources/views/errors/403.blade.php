<x-app-layout noindex="true">
    <div
        ...
        <p class="font-bold text-lg xs:text-2xl sm:text-3xl lg:text-4xl text-gray-900 dark:text-gray-100 leading-tight mb-4 sm:mb-6 lg:mb-8">
            {{ __('Session timed out') }}
        </p>
        <p class="text-lg xs:text-2xl sm:text-3xl lg:text-4xl text-gray-600 dark:text-gray-400 mb-6 sm:mb-8 lg:mb-10">
