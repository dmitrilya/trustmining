<x-app-layout>
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-8" style="height: calc(100dvh - 64.4px)">
        <div
            ...
            <ul class="flex text-sm font-medium text-center text-gray-500 rounded-t-2xl divide-x divide-gray-200 border-b border-gray-200 dark:divide-gray-600 dark:text-gray-400 rtl:divide-x-reverse"
                ...
                <li class="w-full">
                    <button id="question-tab" data-tabs-target="#question" type="button" role="tab"
                        ...
                        class="inline-block w-full p-4 rounded-se-2xl bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">
                        {{ __('Your question') }}
                        @if (
                            $auth &&
