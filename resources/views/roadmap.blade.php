        ...
        @guest
            <div class="col-span-2 bg-gray-900 hidden lg:flex flex-col h-full w-full relative z-10 overflow-hidden">
                    ...
                    <div class="w-full sm:max-w-md mt-6 px-6 py-4 overflow-hidden rounded-lg z-10">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="flex items-center justify-end mt-6 lg:mt-8">
                                <a class="underline text-sm text-gray-500 hover:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
                                    href="{{ route('login') }}">
                                    {{ __('Login') }}
                                </a>
                ...
                <div class="p-2 sm:p-4 lg:p-6">
                    <div class="text-xs text-gray-600">ИП Дмитриева Елизавета Николаевна</div>
                    <div class="text-xs text-gray-600 mb-2">ОГРНИП: 325385000082654</div>
                    <div class="text-xxs text-gray-500" style ="max-width: 1312px;">© 2025 -
            ...
            <div class="w-full px-4 sm:px-8 xl:px-12 py-8 space-y-12 sm:space-y-16 lg:space-y-20 xl:space-y-28 overflow-x-hidden"
                ...
                <article>
                    <header class="-ml-4 sm:-ml-8 xl:-ml-12 flex items-center mb-6 md:mb-8">
                        ...
                        <div class="date-transform text-xs text-gray-700 dark:text-gray-300 font-semibold" data-type="date"
                            data-date="{{ Carbon\Carbon::create('22-08-2025')->timestamp * 1000 }}"></div>
                    </header>

                    <div class="text-lg md:text-xl lg:text-2xl xl:text-3xl text-gray-900 dark:text-gray-100 font-semibold mb-2 lg:mb-3">
                        {{ __('Project launch') }}</div>
                    <div class="text-xs lg:text-sm text-gray-600 mb-6 md:mb-8">
                    ...
                    <div class="md:text-lg text-gray-800 dark:text-gray-200 font-semibold mb-2 md:mb-4">{{ __('Stage goals') }}</div>
                    <ul class="space-y-2 md:space-y-3 list-disc pl-8">
                        <li class="text-xs sm:text-sm text-gray-700 dark:text-gray-300 pl-2">{{ __('Invitation of large companies') }}
                        </li>
                        <li class="text-xs sm:text-sm text-gray-700 dark:text-gray-300 pl-2">{{ __('Testing basic functions') }}</li>
                        <li class="text-xs sm:text-sm text-gray-700 dark:text-gray-300 pl-2">{{ __('Bug fixes and optimization') }}</li>
                        <li class="text-xs sm:text-sm text-gray-700 dark:text-gray-300 pl-2">
                ...
                <article>
                    ...
                    <div class="md:text-lg text-gray-800 dark:text-gray-200 font-semibold mb-2 md:mb-4">{{ __('List of changes') }}</div>
                    <ul class="space-y-2 md:space-y-3 list-disc pl-8">
                        <li class="text-xs sm:text-sm text-gray-700 dark:text-gray-300 pl-2">
