<form action="{{ route('forum.comment.update', ['forumComment' => $comment->id]) }}" method="POST" x-data="{ text: `{{ $comment->text }}`, range: null, link_text: null, link_url: null }"
    ...
    <div class="flex items-center justify-between px-3 py-1 border-t dark:border-zinc-700" x-data="{ images: {{ count($comment->images) }}, files: {{ count($comment->files) }} }">
        <div class="flex ps-0 space-x-1 rtl:space-x-reverse">
            ...
            <div class="flex flex-col justify-center ml-2">
                <div class="text-xxs sm:text-xs text-gray-500" style="display: hidden" x-show="files > 0">
