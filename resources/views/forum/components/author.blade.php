<div itemprop="author" itemscope itemtype="https://schema.org/Person" class="mb-2 sm:mb-4 lg:mb-6 flex items-center">
    <div
        class="size-12 sm:size-14 lg:size-16 mr-2 sm:mr-3 lg:mr-4 rounded-full border border-indigo-500 p-0.5 overflow-hidden">
    ...
    <div>
        <h4 itemprop="name" class="mb-1 sm:mb-1.5 text-xs sm:text-sm lg:text-base text-gray-700 dark:text-gray-300 font-bold">
            {{ $name }}</h4>
        <div class="flex items-center xs:mb-0.5">
            ...
            <div class="ml-1 sm:ml-2 text-xxs xs:text-xs lg:text-sm text-gray-500">{{ __($status) }}</div>
        </div>
        <div class="flex items-center">
            ...
            <div class="ml-1 sm:ml-2 text-xxs xs:text-xs lg:text-sm text-gray-500">{{ $messages }}</div>
        </div>
    </div>
</div>
