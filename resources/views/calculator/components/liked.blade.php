<div
    class="bg-white/40 dark:bg-slate-900/40 border border-slate-300 dark:border-slate-700 shadow-sm shadow-logo-color rounded-xl p-2 sm:p-4">
    <h2
    ...
    <a href="https://t.me/trustmining_calculator_bot" target="_blank" class="mb-2 sm:mb-3">
        <x-buttons.secondary-button class="flex items-center bg-secondary-gradient dark:text-slate-800">
    ...
    <x-buttons.secondary-button class="flex items-center mb-2 sm:mb-3"
    ...
    <x-buttons.primary-button class="flex items-center mb-2 sm:mb-3"
