<x-faqs.faqs>
    ...
    <x-faqs.faq i="6" :question="__('faq.calculator.question_6', ['b' => $selModel['b'], 'm' => $selModel['n']])" :answer="__('faq.calculator.answer_6', ['b' => $selModel['b'], 'm' => $selModel['n'], 'v' => $selVersion['h'] . $selVersion['m']])" />
</x-faqs.faqs>
