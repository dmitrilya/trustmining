    ...
    <div itemscope itemtype="https://schema.org/FAQPage" class="max-w-3xl mx-auto space-y-4" x-data="{ active: null }">
        <div itemprop="mainEntity" itemscope itemtype="https://schema.org/Question"
            ...
            <button @click="active !== 1 ? active = 1 : active = null"
                ...
                <span itemprop="name">
                    {{ __('faq.calculator.question_1', ['m' => $selModel->name]) }}
                </span>
            ...
            <div itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer" x-show="active === 1"
                ...
                <div itemprop="text"
                    ...
                    {{ __('faq.calculator.answer_1', ['a' => $selModel->algorithm->name, 'b' => $selModel->asicBrand->name, 'm' => $selModel->name]) }}
                </div>
            </div>
        </div>
        ...
        <div itemprop="mainEntity" itemscope itemtype="https://schema.org/Question"
            ...
            <div itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer" x-show="active === 2"
                ...
                <div itemprop="text"
                    class="p-4 text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800">
                    {{ __('faq.calculator.answer_2', ['p' => $selVersion->efficiency * $selVersion->hashrate]) }}
                </div>
            </div>
        </div>
        ...
        <div itemprop="mainEntity" itemscope itemtype="https://schema.org/Question"
            ...
            <div itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer" x-show="active === 3"
                ...
                <div itemprop="text"
                    class="p-4 text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800">
                    {{ __('faq.calculator.answer_3', ['b' => $selModel->asicBrand->name, 'm' => $selModel->name]) }}
                </div>
            </div>
        </div>
        ...
        <div itemprop="mainEntity" itemscope itemtype="https://schema.org/Question"
            ...
            <button @click="active !== 4 ? active = 4 : active = null"
                class="flex justify-between items-center w-full p-4 text-left font-semibold text-slate-800 dark:text-slate-200 transition-all">
                <span itemprop="name">
                    {{ __('faq.calculator.question_4', ['b' => $selModel->asicBrand->name, 'm' => $selModel->name, 'v' => $selVersion->hashrate . $selVersion->measurement]) }}
                </span>
                <svg class="ml-2 sm:ml-3 w-5 h-5 transition-transform duration-300"
            ...
            <div itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer" x-show="active === 4"
                ...
                <div itemprop="text"
                    ...
                    {{ __('faq.calculator.answer_4', ['e' => $selVersion->efficiency . ' j/' . $selVersion->measurement, 'p' => $selVersion->efficiency * $selVersion->hashrate, 'v' => $selVersion->hashrate . $selVersion->measurement, 'a' => $selModel->algorithm->name]) }}
                </div>
            </div>
        </div>
        ...
        <div itemprop="mainEntity" itemscope itemtype="https://schema.org/Question"
            ...
            <button @click="active !== 5 ? active = 5 : active = null"
                class="flex justify-between items-center w-full p-4 text-left font-semibold text-slate-800 dark:text-slate-200 transition-all">
                <span itemprop="name">
                    {{ __('faq.calculator.question_5', ['m' => $selModel->name]) }}
                </span>
                <svg class="ml-2 sm:ml-3 w-5 h-5 transition-transform duration-300"
            ...
            <div itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer" x-show="active === 5"
                ...
                <div itemprop="text"
                    class="p-4 text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800 space-y-2">
                    {{ __('faq.calculator.answer_5', ['b' => $selModel->asicBrand->name, 'm' => $selModel->name, 'a' => $selModel->algorithm->name]) }}
                </div>
            </div>
        </div>
        ...
        <div itemprop="mainEntity" itemscope itemtype="https://schema.org/Question"
            ...
            <button @click="active !== 6 ? active = 6 : active = null"
                class="flex justify-between items-center w-full p-4 text-left font-semibold text-slate-800 dark:text-slate-200 transition-all">
                <span itemprop="name">
                    {{ __('faq.calculator.question_6', ['b' => $selModel->asicBrand->name, 'm' => $selModel->name]) }}
                </span>
                <svg class="ml-2 sm:ml-3 w-5 h-5 transition-transform duration-300"
            ...
            <div itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer" x-show="active === 6"
                x-collapse x-cloak>
                <div itemprop="text"
                    class="p-4 text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800 space-y-2">
                    {{ __('faq.calculator.answer_6', ['b' => $selModel->asicBrand->name, 'm' => $selModel->name, 'v' => $selVersion->hashrate . $selVersion->measurement]) }}
                </div>
            </div>
        </div>
    </div>
