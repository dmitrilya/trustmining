    <div class="mt-8 sm:mt-10">
        @if (!$widjet)
            <div class="mt-6">
                ...
                <div class="flex items-center">
                    ...
                    <a :href="version ? `/asic-miners/${version.bs}/${version.ns}/reviews` : '#'" class="ml-3 text-sm text-indigo-500 hover:text-indigo-600">
        ...
        <div class="mt-3 xs:mt-4 sm:mt-5 space-y-1 sm:space-y-1.5 md:space-y-2" style="min-height: 120px">
            <x-characteristics.characteristics>
                <x-characteristics.characteristic name="Algorithm" x-value="version ? algorithms[version.a].n : '-'" />
                <x-characteristics.characteristic name="Efficiency" x-value="version ? version.e + ' j/' + version.m : '-'" />
                <x-characteristics.characteristic name="Power" x-value="version ? Math.round(version.e * version.h) + ' {{ __('W') }}' : '-'" />
                @if (!$widjet)
                    <x-characteristics.characteristic name="The best price" x-value="version?.p ? version.p + ' USDT' : '{{ __('No data') }}'" />
                @endif
                <x-characteristics.characteristic x-name="(version ? algorithms[version.a].p[profitNumber].c[0].a : '') + 'USDT'"
                    x-value="version ? algorithms[version.a].p[profitNumber].c[0].r : '-'" />
