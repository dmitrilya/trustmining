<div x-show="filter" class="fixed z-40" style="display: none" role="dialog" aria-modal="true">
    ...
    <div x-show="filter"
        class="fixed top-0 right-0 p-4 h-max w-full sm:max-w-sm flex-col overflow-y-auto bg-white/60 dark:bg-zinc-900/60 backdrop-blur-2xl shadow-md shadow-logo-color flex ml-auto"
