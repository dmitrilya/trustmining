<div x-show="filter" class="fixed z-40" style="display: none" role="dialog" aria-modal="true">
    ...
    <div x-show="filter"
        class="fixed top-0 right-0 p-4 h-max w-full sm:max-w-sm flex-col overflow-y-auto bg-white dark:bg-zinc-900 shadow-md dark:shadow-zinc-800 flex ml-auto"
        ...
        <div class="flex items-center justify-between">
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-200">{{ __('Filters') }}</h2>

            <button type="button"
                class="-mr-2 flex h-10 w-10 items-center justify-center rounded-md bg-white dark:bg-zinc-950 p-2 text-gray-400"
                @click="filter = false">
