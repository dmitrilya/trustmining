...
<div itemprop="mainEntity" itemscope itemtype="https://schema.org"
    class="border rounded-xl overflow-hidden shadow bg-white/40 dark:bg-slate-900/40 border-l-4 border-l-indigo-600 dark:border-l-indigo-600 transition-all duration-300"
    ...
    <button type="button" @click="active !== {{ $i }} ? active = {{ $i }} : active = null"
        ...
        <svg class="ml-2 sm:ml-3 w-5 h-5 transition-all duration-300" :class="active === {{ $i }} ? 'rotate-180' : ''" fill="none"
