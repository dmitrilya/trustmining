...
<div x-data="{ max: {{ $max }}, length: {{ mb_strlen($value) }} }"
    class="{{ $class }} flex items-center py-1.5 px-3 block mt-1 w-full rounded-md shadow-sm shadow-logo-color text-gray-950 bg-white dark:bg-zinc-950 dark:text-gray-200 border-0 ring-1 ring-inset ring-gray-300 dark:ring-zinc-700 focus-within:ring-indigo-500 dark:focus-within:ring-indigo-500">
    ...
    <div class="min-w-fit ml-2 sm:ml-3 text-xxs sm:text-xs text-gray-600 dark:text-gray-400">
