...
<div class="flex items-center">
    @if (!$withoutSort)
        <x-dropdown align="right" width="48" contentClasses="bg-white/80 dark:bg-slate-900/80 border border-slate-300 dark:border-slate-700">
            <x-slot name="trigger">
                <button
    ...
    {{-- <button type="button" class="-m-2 ml-5 p-2 text-slate-500 hover:text-slate-500 sm:ml-7">
    ...
    <button
        ...
        type="button" class="-m-2 ml-1 xs:ml-2 p-2 text-slate-500 hover:text-slate-500 dark:hover:text-slate-400 sm:ml-4">
