...
<div x-data="{ max: {{ $max }}, length: {{ mb_strlen($value) }} }"
    class="{{ $class }} flex items-center py-1.5 px-3 block mt-1 w-full rounded-lg shadow-sm shadow-logo-color text-slate-800 bg-white dark:bg-slate-950 dark:text-slate-200 border-0 ring-1 ring-inset ring-slate-300 dark:ring-slate-700 focus-within:ring-indigo-500 dark:focus-within:ring-indigo-500">
