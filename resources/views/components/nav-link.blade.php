...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center border-b-2 border-indigo-400 dark:border-indigo-700 text-sm leading-5 text-slate-950 dark:text-slate-50 focus:outline-none focus:border-indigo-700 transition duration-100 ease-in-out'
