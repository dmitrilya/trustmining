...
<div
    {{ $attributes->merge(['class' => 'flex items-center w-fit px-1.5 py-0.5 rounded-full border ' . ($tf > config('trustfactor.yellow') ? ($tf > config('trustfactor.green') ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-800 dark:text-emerald-400' : 'bg-amber-500/10 border-amber-500/30 text-amber-800 dark:text-amber-200') : 'bg-rose-500/10 border-rose-500/30 text-rose-600 dark:text-rose-400')]) }}>
