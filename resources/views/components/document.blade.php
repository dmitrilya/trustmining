...
<div {{ $attributes->merge(['class' => 'bg-gray-100 dark:bg-zinc-800 p-3 rounded-lg']) }}>
    <div class="flex items-center">
        <div class="rounded-md overflow-hidden min-w-14 w-14 h-14 mr-4 bg-white dark:bg-zinc-950 flex items-center justify-center">
            <svg class="w-7 h-7 text-gray-600 aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                viewBox="0 0 16 20">
        ...
        <div class="grow min-w-0">
            ...
            <div class="flex">
                ...
                <a class="hover:underline text-gray-600" download href="{{ Storage::url($path) }}">
                    {{ __('Download') }}
                </a>
            </div>
        </div>
