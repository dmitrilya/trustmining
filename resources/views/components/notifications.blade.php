...
<div class="w-5 h-5" x-data="{ open: false }">
    ...
    <div x-show="open"
        class="absolute z-10 mt-5 flex max-w-sm md:max-w-md lg:max-w-lg right-2 sm:right-6 lg:right-8 overflow-hidden border border-slate-300 dark:border-slate-700 rounded-3xl shadow-lg shadow-logo-color backdrop-blur-2xl"
        ...
        <div class="w-full flex-auto bg-white/40 dark:bg-slate-900/40 text-sm leading-6">
            ...
            <a href="{{ route('notifications') }}"
                ...
                <div class="inline-flex items-center ">
                    <svg class="w-4 h-4 me-2 text-slate-500 dark:text-slate-400" aria-hidden="true" fill="currentColor"
                        viewBox="0 0 20 14">
                        <path
