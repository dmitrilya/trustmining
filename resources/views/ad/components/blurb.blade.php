<div class="flex flex-col md:flex-row gap-2 sm:gap-3 lg:gap-4 mb-4">
    <div class="hidden w-full p-2 sm:p-3 md:p-4 bg-white/60 dark:bg-zinc-900/60 border border-gray-300 dark:border-zinc-700 shadow-lg shadow-logo-color overflow-hidden rounded-lg md:grid grid-cols-9">
        <div
