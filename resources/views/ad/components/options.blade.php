...
<div x-data="{ open: false }">
    <button @click="open = ! open"
        class="ml-2 xs:ml-3 inline-flex items-center p-2 text-sm font-medium text-center text-gray-900 bg-white rounded-md hover:bg-gray-100 focus:ring-inset focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-zinc-900 dark:hover:bg-zinc-800 dark:focus:ring-zinc-700">
