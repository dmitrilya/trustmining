<div class="space-y-6">
    <input type="hidden" name="props" x-ref="props_containers"
        value='{"Capacity": 60, "Power (kW)": "200", "Length (cm)": 0, "Width (cm)": 0, "Height (cm)": 0}'>
    ...
    <div>
        ...
        <textarea id="description" rows="16" name="description"
            class="mt-1 px-3 py-2 resize-none w-full px-0 text-sm text-gray-950 dark:text-gray-200 bg-gray-100 dark:bg-zinc-950 rounded-md border-gray-300 dark:border-zinc-700 focus:border-indigo-500 dark:focus:border-indigo-500 focus:ring-indigo-500 shadow-sm dark:shadow-zinc-800"
