...
quill.on('text-change', () => description = quill.root.innerHTML);">
    ...
    <div>
        ...
        <x-inputs.text-input id="capacity" name="capacity" type="number" min="30" autocomplete="capacity" value="60"
    ...
    <div>
        ...
        <x-inputs.text-input id="power" name="power" type="number" min="90" autocomplete="power" value="200"
