<div
    class="p-2 sm:p-3 bg-white/40 dark:bg-slate-900/40 border border-slate-300 dark:border-slate-700 shadow shadow-logo-color rounded-xl">
    <h2 class="text-xs text-slate-500 uppercase tracking-widest mb-4">
        {{ __('Advertisements') }}
    </h2>
