    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-6 sm:py-8 lg:py-10 space-y-6 lg:space-y-8">
                    ...
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" width="20" height="20" viewBox="0 0 20 20"
                        ...
                        <g clip-path="url(#clip0_1181_4290)">
                            <path
                                ...
                                fill="white" />
                            <path
                                d="M16.4763 9.87209C16.4759 9.84074 16.4636 9.81074 16.4418 9.78818C16.42 9.76562 16.3905 9.7522 16.3592 9.75066C14.0356 9.66263 12.621 9.36634 11.632 8.37731C10.6405 7.38584 10.3448 5.97059 10.2568 3.64159C10.2557 3.61013 10.2424 3.58033 10.2197 3.55846C10.1971 3.5366 10.1668 3.52439 10.1353 3.52441H9.86456C9.83321 3.52484 9.80321 3.53719 9.78065 3.55896C9.75809 3.58073 9.74467 3.61028 9.74313 3.64159C9.6551 5.96938 9.35942 7.38584 8.36795 8.37731C7.3777 9.36695 5.96427 9.66263 3.64074 9.75066C3.60928 9.75177 3.57947 9.76504 3.55761 9.7877C3.53575 9.81035 3.52354 9.84061 3.52356 9.87209V10.1435C3.52356 10.2084 3.57577 10.2619 3.64074 10.2649C5.96427 10.3529 7.37892 10.6492 8.36795 11.6389C9.3576 12.6285 9.65267 14.0395 9.74192 16.3594C9.74302 16.3909 9.7563 16.4207 9.77895 16.4425C9.8016 16.4644 9.83186 16.4766 9.86335 16.4766H10.1353C10.1668 16.4762 10.1969 16.4637 10.2195 16.4418C10.242 16.4199 10.2554 16.3902 10.2568 16.3588C10.346 14.0395 10.6411 12.6279 11.6307 11.6389C12.621 10.648 14.035 10.3529 16.3586 10.2649C16.39 10.2638 16.4198 10.2505 16.4417 10.2279C16.4635 10.2052 16.4758 10.175 16.4757 10.1435L16.4763 9.87209Z"
                                fill="#171717" />
                        </g>
                        <defs>
                            <clipPath id="clip0_1181_4290">
                                <rect width="17" height="17" fill="white" transform="translate(1.5 1.50098)" />
                            </clipPath>
                        </defs>
                    </svg>
                </div>
        ...
        <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="space-y-2">
                ...
                <a class="w-max under text-sm text-slate-800 dark:text-slate-200"
                    href="{{ route('tax') }}">{{ __('About taxes') }}</a>
                <a class="w-max under text-sm text-slate-800 dark:text-slate-200"
        ...
        <div>
            <div class="text-sm text-slate-500">ИП Дмитриева Елизавета Николаевна</div>
            <div class="text-sm text-slate-500">ОГРНИП: 325385000082654</div>
        </div>
        <div class="text-xs text-slate-500" style ="max-width: 1312px;">© 2025 - {{ Carbon\Carbon::now()->year }}.
