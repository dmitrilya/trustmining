    ...
    <div role="listbox" style="display: none" x-show="open && sugs"
        ...
        <div class="relative select-none hover:bg-gray-100 dark:hover:bg-zinc-800 ring-1 ring-inset ring-indigo-500 dark:ring-indigo-600">
            <a href="#" class="flex items-center text-sm py-2 px-3">
                ...
                <div
                    class="ml-auto inline-flex items-center px-2 py-1 bg-gray-50 dark:bg-zinc-900 border border-gray-300 dark:border-zinc-700 rounded-md text-xxs text-gray-700 dark:text-gray-400 uppercase shadow-sm dark:shadow-zinc-800 transition ease-in-out duration-150">
                    {{ __('Company') }}</div>
            </a>
        </div>
