        ...
        <div
            ...
            <div class="sm:grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                <div class="space-y-4 w-full mb-6 sm:mb-0">
                    ...
                    {{-- <div class="group flex items-center">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            aria-hidden="true" class="w-4 h-4 lg:w-5 lg:h-5 text-gray-500 mr-2">
                    ...
                    <div class="group flex items-center">
                        <svg class="w-4 h-4 lg:w-5 lg:h-5 text-gray-500 mr-2" aria-hidden="true" width="24"
                ...
                <div class="space-y-4 w-full">
                    ...
                    <div class="group flex items-center">
                        <svg class="w-4 h-4 lg:w-5 lg:h-5 text-gray-500 mr-2" aria-hidden="true" stroke-width="1.5"
                    ...
                    <div class="group flex items-center">
                        <svg class="w-4 h-4 lg:w-5 lg:h-5 text-gray-500 mr-2" fill="none" viewBox="0 0 24 24"
