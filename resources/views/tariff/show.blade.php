<x-app-layout title="Приобрести подписку {{ $tariff->name }}">
                ...
                <div class="grid grid-cols-3 gap-1 xs:gap-2 sm:gap-4 md:gap-6">
                    <div>
                        ...
                        <label for="qr"
                            ...
                            <div class="ml-2 sm:ml-4 text-xxs xs:text-xs sm:text-sm md:text-base font-semibold">QR
                            </div>
                        </label>
                    </div>
                    ...
                    <div>
                        ...
                        <label for="card"
                            ...
                            <div class="ml-2 sm:ml-4 text-xxs xs:text-xs sm:text-sm md:text-base font-semibold">
                                {{ __('Card') }}</div>
                        </label>
                    </div>
