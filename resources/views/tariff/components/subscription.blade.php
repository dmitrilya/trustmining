<div
    class="w-full max-w-sm mx-auto shadow-lg bg-gray-900 dark:bg-zinc-900 border-2 border-indigo-500 rounded-3xl px-8 py-10 sm:px-10 sm:py-12 lg:px-14 lg:py-18 space-y-4 sm:space-y-8">
