<div class="grid justify-items-center grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-8 -mt-72">
    <div
        class="w-full max-w-md shadow-lg bg-white border border-slate-300 rounded-xl px-8 py-10 sm:px-10 sm:py-12 lg:px-14 lg:py-18 space-y-4 sm:space-y-8">
        <div class="text-slate-800 font-semibold text-lg md:text-2xl">{{ $tariffs[0]->name }}</div>
        ...
        <div class="h-9 flex items-end text-slate-500 md:text-lg"><span
                class="text-slate-800 font-bold text-2xl sm:text-3xl lg:text-4xl">{{ $tariffs[0]->price * 30 }}</span>
            /{{ __('month') }}</div>
        <a
        ...
        <div class="space-y-2 sm:space-y-4">
            <div class="flex items-center">
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-800 font-semibold text-base sm:text-lg lg:text-xl">{{ $tariffs[0]->max_ads }}</span>
                    {{ __('of ads') }}</div>
            </div>
            <div class="flex items-center">
                <svg class="mr-4 flex-shrink-0 w-4 h-4 text-indigo-500" aria-hidden="true"
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-800 font-semibold text-base sm:text-lg lg:text-xl">{{ $tariffs[0]->max_offices }}</span>
                    {{ __('of offices') }}</div>
            </div>
    ...
    <div
        class="w-full max-w-md shadow-lg bg-white border border-slate-300 rounded-xl px-8 py-10 sm:px-10 sm:py-12 lg:px-14 lg:py-18 space-y-4 sm:space-y-8">
        <div class="text-slate-800 font-semibold text-lg md:text-2xl">{{ $tariffs[1]->name }}</div>
        <div class="text-slate-500 text-sm md:text-base">{{ __($tariffs[1]->description) }}</div>
        <div class="h-9 flex items-end text-slate-500 md:text-lg"><span
                class="text-slate-800 font-bold text-2xl sm:text-3xl lg:text-4xl">{{ $tariffs[1]->price * 30 }}</span>
            /{{ __('month') }}</div>
        <a
        ...
        <div class="space-y-2 sm:space-y-4">
            <div class="flex items-center">
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-800 font-semibold text-base sm:text-lg lg:text-xl">{{ $tariffs[1]->max_ads }}</span>
                    {{ __('of ads') }}</div>
            </div>
            <div class="flex items-center">
                <svg class="mr-4 flex-shrink-0 w-4 h-4 text-indigo-500" aria-hidden="true"
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-800 font-semibold text-base sm:text-lg lg:text-xl">{{ $tariffs[1]->max_offices }}</span>
                    {{ __('of offices') }}</div>
            </div>
    ...
    <div
        class="w-full max-w-md shadow-lg bg-slate-900 border-2 border-indigo-500 rounded-xl px-8 py-10 sm:px-10 sm:py-12 lg:px-14 lg:py-18 space-y-4 sm:space-y-8">
        ...
        <div class="space-y-2 sm:space-y-4">
            <div class="flex items-center">
                ...
                <div class="text-sm text-slate-400"><span
            ...
            @if ($tariffs[2]->can_have_hosting)
                <div class="flex items-center">
                    ...
                    <div class="text-sm text-slate-400">{{ __('Hosting adding') }}</div>
                </div>
            @endif
            @if ($tariffs[2]->can_have_phone)
                <div class="flex items-center">
                    ...
                    <div class="text-sm text-slate-400">{{ __('Phone number') }}</div>
                </div>
            @endif
            @if ($tariffs[2]->can_create_insight)
                <div class="flex items-center">
                    ...
                    <div class="text-sm text-slate-400">{{ __('Guide creating') }}</div>
                </div>
            @endif
            <div class="flex items-center">
                <svg class="mr-4 flex-shrink-0 w-4 h-4 text-white" aria-hidden="true" fill="currentColor"
            ...
            <div class="flex items-center">
                ...
                <div class="text-sm text-slate-400">{{ __('Advertising space on the website') }}</div>
            </div>
            <div class="text-xxs text-slate-400">* {{ __('Advertising space is paid for separately. The price is determined in an auction format') }}</div>
        </div>
    </div>
</div>
...
<div class="grid justify-items-center mt-4 lg:mt-8">
    <div
        class="w-full max-w-md lg:max-w-none bg-white border border-slate-300 rounded-xl px-10 py-8 sm:px-12 sm:py-10 lg:px-18 lg:py-14 space-y-3 sm:space-y-4">
        <div class="text-slate-800 font-semibold text-lg md:text-2xl">Base</div>
        ...
        <div class="space-y-2 sm:space-y-0 sm:flex sm:space-x-10">
            <div class="flex items-center">
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-800 font-semibold text-base sm:text-lg lg:text-xl">2</span>
                    {{ __('of ads') }}</div>
            </div>
            <div class="flex items-center">
                <svg class="mr-4 flex-shrink-0 w-4 h-4 text-indigo-500" aria-hidden="true"
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-800 font-semibold text-base sm:text-lg lg:text-xl">1</span>
                    {{ __('of offices') }}</div>
            </div>
        </div>
    </div>
