<div class="grid justify-items-center grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-8 -mt-72">
    <div
        ...
        <div class="h-9 flex items-end text-slate-500 md:text-lg"><span
                class="text-slate-950 font-bold text-2xl sm:text-3xl lg:text-4xl">{{ $tariffs[0]->price * 30 }}</span>
            /{{ __('month') }}</div>
        <a
        ...
        <div class="space-y-2 sm:space-y-3">
            <div class="flex items-center">
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-950 font-semibold text-base sm:text-lg lg:text-xl">{{ $tariffs[0]->max_ads }}</span>
                    {{ __('of ads') }}</div>
            </div>
            <div class="flex items-center">
                <svg class="mr-4 flex-shrink-0 w-4 h-4 text-indigo-600 dark:text-indigo-500" aria-hidden="true"
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-950 font-semibold text-base sm:text-lg lg:text-xl">{{ $tariffs[0]->max_offices }}</span>
                    {{ __('of offices') }}</div>
            </div>
    ...
    <div
        ...
        <div class="h-9 flex items-end text-slate-500 md:text-lg"><span
                class="text-slate-950 font-bold text-2xl sm:text-3xl lg:text-4xl">{{ $tariffs[1]->price * 30 }}</span>
            /{{ __('month') }}</div>
        <a
        ...
        <div class="space-y-2 sm:space-y-3">
            <div class="flex items-center">
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-950 font-semibold text-base sm:text-lg lg:text-xl">{{ $tariffs[1]->max_ads }}</span>
                    {{ __('of ads') }}</div>
            </div>
            <div class="flex items-center">
                <svg class="mr-4 flex-shrink-0 w-4 h-4 text-indigo-600 dark:text-indigo-500" aria-hidden="true"
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-950 font-semibold text-base sm:text-lg lg:text-xl">{{ $tariffs[1]->max_offices }}</span>
                    {{ __('of offices') }}</div>
            </div>
    ...
    <div
        ...
        <div class="space-y-2 sm:space-y-0 sm:flex sm:space-x-10">
            <div class="flex items-center">
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-950 font-semibold text-base sm:text-lg lg:text-xl">2</span>
                    {{ __('of ads') }}</div>
            </div>
            <div class="flex items-center">
                <svg class="mr-4 flex-shrink-0 w-4 h-4 text-indigo-600 dark:text-indigo-500" aria-hidden="true"
                ...
                <div class="text-sm text-slate-500"><span
                        class="text-slate-950 font-semibold text-base sm:text-lg lg:text-xl">1</span>
                    {{ __('of offices') }}</div>
            </div>
        </div>
    </div>
