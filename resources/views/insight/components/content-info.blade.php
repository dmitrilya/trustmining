        ...
        <div itemprop="interactionStatistic" itemscope itemtype="https://schema.org/InteractionCounter"
            ...
            <button aria-label="Like"
                ...
                <svg x-show="liked" aria-hidden="true" height="24" fill="currentColor" viewBox="0 0 24 24"
                    class="size-5 sm:size-6 lg:size-7 text-slate-800 dark:text-slate-200">
                ...
                <svg x-show:="!liked" aria-hidden="true" width="24" height="24" fill="none"
                    viewBox="0 0 24 24"
                    class="size-5 sm:size-6 lg:size-7 text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200">
            ...
            <p class="text-xxs sm:text-xs text-slate-500 ml-1.5" x-text="likes"></p>
        </div>
        <div itemprop="interactionStatistic" itemscope itemtype="https://schema.org/InteractionCounter"
            class="flex items-center ml-4">
            <svg class="size-5 sm:size-6 text-slate-800 dark:text-slate-200" aria-hidden="true" width="24"
            ...
            <p itemprop="userInteractionCount" class="text-xxs sm:text-xs text-slate-500 ml-1.5">
