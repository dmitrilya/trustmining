<div class="flex items-center justify-between">
    ...
    <div class="ml-auto flex items-center">
        <div itemprop="interactionStatistic" itemscope itemtype="https://schema.org/InteractionCounter"
            ...
            <button aria-label="Like"
                ...
                <svg x-show:="!liked" aria-hidden="true" width="24" height="24" fill="none"
                    viewBox="0 0 24 24"
                    class="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200">
        ...
        <div itemprop="interactionStatistic" itemscope itemtype="https://schema.org/InteractionCounter"
            ...
            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-slate-800 dark:text-slate-200" aria-hidden="true" width="24"
