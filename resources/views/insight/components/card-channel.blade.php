    ...
    <div itemprop="author" itemscope itemtype="https://schema.org/Organization" class="flex items-center">
        ...
        <div>
            ...
            <div itemprop="interactionStatistic" itemscope itemtype="https://schema.org/InteractionCounter"
                ...
                <svg class="w-3.5 h-3.5 text-slate-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                ...
                <div itemprop="userInteractionCount" class="ml-1 sm:ml-2 text-xxs sm:text-xs text-slate-500">
                    {{ $subscribers }}</div>
            </div>
        </div>
