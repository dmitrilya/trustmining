        ...
        <form method="POST" class="flex flex-col gap-2 sm:gap-4 lg:gap-6" enctype=multipart/form-data
            ...
            <div class="sm:flex sm:space-x-3 space-y-2 sm:space-y-0">
                <div class="w-full">
                    ...
                    <x-length-input id="channel-name" name="name" type="text" :value="old('name')"
                ...
                <div class="w-full">
                    ...
                    <x-length-input id="channel-slug" name="slug" type="text" :value="old('slug')"
            ...
            <div>
                ...
                <x-length-input id="channel-brief_description" name="brief_description" type="text" :value="old('brief_description')"
            ...
            <div>
                ...
                <x-file-input id="channel-logo" name="logo" class="mt-1 block w-full" accept=".png,.jpg,.jpeg,.webp"
                    required />
                <p class="mt-1 text-xxs text-slate-500" id="channel-logo_help">PNG, JPG
                    or JPEG (max. 2MB)</p>
            ...
            <div>
                ...
                <p class="mt-1 text-xxs text-slate-500" id="channel-banner_help">PNG, JPG
