<x-insight-layout title="Добавление видео | TM Insight"
        ...
        <div
            ...
            <form action="{{ route('insight.video.store', ['channel' => $channel->slug]) }}" method="POST"
                ...
                <div class="w-full">
                    ...
                    <x-length-input id="video-title" name="title" type="text" :value="old('title')"
                ...
                <div class="w-full">
                    ...
                    <x-text-input id="video-url" name="url" type="text" :value="old('url')"
