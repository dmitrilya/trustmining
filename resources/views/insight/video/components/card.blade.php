<div itemprop="item" itemscope itemtype="https://schema.org/VideoObject"
    class="card relative sm:max-w-md h-full bg-white/60 dark:bg-zinc-900/60 border border-gray-300 dark:border-zinc-700 overflow-hidden rounded-xl flex flex-col">
    ...
    <div class="flex flex-col flex-grow justify-between p-2 sm:p-3">
        <div>
            ...
            <h3 itemprop="name"
                class="mt-1.5 mb-2 sm:mt-2 sm:mb-2.5 text-xs sm:text-sm font-bold text-gray-800 dark:text-gray-200 h-16 line-clamp-3">
                {{ $video->title }}</h3>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2 xs:gap-3 sm:gap-4">
                    <div itemprop="interactionStatistic" itemscope itemtype="https://schema.org/InteractionCounter"
                        ...
                        <svg class="w-3 h-3 xs:w-4 xs:h-4 text-gray-700 dark:text-white" aria-hidden="true"
