<x-insight-layout :title="__('meta.insight.content.post.create.title')" :description="__('meta.insight.content.post.create.description')" :header="__('meta.insight.content.post.create.header')">
