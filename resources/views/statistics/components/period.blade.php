    ...
    <div class="flex max-w-max bg-slate-100 dark:bg-slate-900 rounded-lg overflow-hidden border dark:border-slate-700 h-7 sm:h-8">
        <div @click="changePeriod('1d');"
            :class="{
                'text-slate-800 dark:text-slate-200 bg-slate-200 dark:bg-slate-800': period ==
                    '1d',
                ' text-slate-800 dark:text-slate-200': period != '1d'
            }"
        ...
        <div @click="changePeriod('3d');"
            :class="{
                'text-slate-800 dark:text-slate-200 bg-slate-200 dark:bg-slate-800': period ==
                    '3d',
                ' text-slate-800 dark:text-slate-200': period != '3d'
            }"
            class="p-2 xs:px-2.5 sm:px-3 text-xxs sm:text-xs cursor-pointer hover:bg-slate-300 dark:hover:bg-slate-700">
            {{ '3' . __('d') }}
        </div>
        <div @click="changePeriod('1w');"
            :class="{
                'text-slate-800 dark:text-slate-200 bg-slate-200 dark:bg-slate-800': period ==
                    '1w',
                ' text-slate-800 dark:text-slate-200': period != '1w'
            }"
            class="p-2 xs:px-2.5 sm:px-3 text-xxs sm:text-xs cursor-pointer hover:bg-slate-300 dark:hover:bg-slate-700">
            {{ '1' . __('w') }}
        </div>
        <div @click="changePeriod('1m');"
            :class="{
                'text-slate-800 dark:text-slate-200 bg-slate-200 dark:bg-slate-800': period ==
                    '1m',
                ' text-slate-800 dark:text-slate-200': period != '1m'
            }"
            class="p-2 xs:px-2.5 sm:px-3 text-xxs sm:text-xs cursor-pointer hover:bg-slate-300 dark:hover:bg-slate-700">
            {{ '1' . __('m') }}
        </div>
