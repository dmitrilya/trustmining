    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 md:px-8 py-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg p-2 sm:p-4 md:p-6 mb-6">
                <div class="mx-auto md:grid md:grid-rows-[auto,auto,1fr] md:gap-x-8 md:px-8 md:py-8 z-10">
                    ...
                    <div class="mt-4 sm:mt-8 md:mt-0 md:col-span-4 md:border-l md:border-gray-200 md:pl-8">
                        <h1
                            class="flex items-center mb-4 text-xl font-bold tracking-tight text-gray-900 sm:text-2xl md:text-3xl{{ isset($moderation->data['address']) ? ' border border-indigo-500' : '' }}">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg p-2 sm:p-4 md:p-6">
            <div class="mx-auto md:grid md:grid-rows-[auto,auto,1fr] md:gap-x-8 md:px-8 md:py-8">
                ...
                <div class="mt-4 sm:mt-8 md:mt-0 md:col-span-4 md:border-l md:border-gray-200 md:pl-8">
                    <h1 class="flex items-center mb-4 text-xl font-bold tracking-tight text-gray-900 sm:text-2xl md:text-3xl">
                    ...
                    <div>
                        ...
                        @else
                            <a class="block mt-6" href="{{ route('chat.start', ['user' => $office->user->id]) }}">
