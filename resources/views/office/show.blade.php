<x-app-layout title="Офис компании {{ $office->user->name }}, точка продаж ASIC майнеров" description="Посетите официальный офис компании {{ $office->user->name }}. В продаже ASIC-майнеры в наличии и под заказ, проверка оборудования на месте, гарантийное обслуживание и консультации экспертов. Узнайте адрес и режим работы прямо сейчас">
    <x-slot name="header">
