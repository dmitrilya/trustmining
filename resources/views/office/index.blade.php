@php
    ...
    if ($serviceFilter) {
        ...
        $description =
            'Рейтинг проверенных криптообменников и организаций по обмену валют. Сравнивайте курсы, читайте реальные отзывы и выбирайте надежные сервисы для безопасного обмена Bitcoin, USDT и других активов на фиат с минимальной комиссией';
    } else {
