    ...
    <div class="max-w-5xl mx-auto px-2 sm:px-6 lg:px-8 py-8">
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow rounded-lg">
            <form method="post" action="{{ route('office.store') }}" class="mt-6 space-y-6" enctype=multipart/form-data>
                ...
                <x-peculiarities :isForm="true"></x-peculiarities>
                ...
                <div class="relative mt-1" x-data="{ open: false, sugs: [] }" @click.away="open = false">
                    <div class="relative z-0 w-full group" @click="if (sugs.length) open = true">
                    ...
                    <ul role="listbox" style="display: none" x-show="open" x-ref="suggestionList"
