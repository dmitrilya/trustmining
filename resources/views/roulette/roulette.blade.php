<div x-data="roulette()" class="relative z-50"
    @open-modal.window="if ($event.detail === 'roulette' ?? !opened) {opened = true; setTimeout(() => { renderContent = true; $nextTick(() => {
    ...
    <template x-if="opened">
        <x-modal name="roulette" maxWidth="2xl" rounded="rounded-xl" :show="true">
