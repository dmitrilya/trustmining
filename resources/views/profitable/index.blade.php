<x-app-layout title="Топ асиков по доходности и окупаемости"
    description="Актуальный рейтинг самых прибыльных ASIC майнеров на {{ now()->year }} год. Таблица доходности и окупаемости асиков для майнинга Bitcoin (BTC) и других валют. Сравнение ТОП-моделей.">
    <x-slot name="header">
