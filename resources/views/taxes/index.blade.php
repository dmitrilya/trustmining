<x-app-layout title="Налоги на майнинг и оборот криптовалюты в России | TRUSTMINING"
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            ...
            <button id="header-toc-toggle"
                class="lg:hidden flex items-center gap-2 px-3 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const toggleBtn = document.getElementById('header-toc-toggle');
            const dropdown = document.getElementById('header-toc-dropdown');
            const tocContainer = document.getElementById('toc-container');

            if (!toggleBtn || !dropdown || !tocContainer) return;
            ...
            const originalTitle = mainH1.textContent.trim();
            let currentActiveText = originalTitle;
            ...
            const updateHeaderTitle = () => {
                ...
                if (scrollY < 100) {
                    if (currentActiveText !== originalTitle) {
                        changeText(originalTitle);
                    }
                    return;
                }
                ...
                if (currentHeading) {
                    const newText = currentHeading.textContent.trim();
            ...
            const changeText = (targetText) => {
                currentActiveText = targetText;
                mainH1.classList.add('opacity-0');

                setTimeout(() => {
                    mainH1.textContent = targetText;
                    mainH1.classList.remove('opacity-0');
                }, 150);
            };
                                ...
                                <div
                                    ...
                                    <ul class="space-y-2 text-xs md:text-sm text-slate-600 dark:text-slate-400">
                                        <li class="flex items-start gap-1.5">
                                            ...
                                            <span>Исключительно <strong class="text-slate-800 dark:text-slate-200">физические лица без статуса
                                                    ИП</strong>.</span>
                                        </li>
                                        <li class="flex items-start gap-1.5">
                                            <span class="text-green-500 font-bold">•</span>
                ...
                <section id="block-2">
                    ...
                    <div class="space-y-6 sm:space-y-8 lg:space-y-12">
                        <div>
                            ...
                            <p class="mb-2 text-slate-600 dark:text-slate-400">
                                Согласно <a href="https://www.consultant.ru/document/cons_doc_LAW_28165/d3cd0da5dfeff39ba9cedcd32c6c42fcfbd97b43/"
                                ...
                                <table class="w-full text-left text-xs sm:text-sm border-collapse">
                                    <thead>
                                        <tr class="text-slate-600 dark:text-slate-400 font-semibold">
                                            <th class="p-2 sm:p-3 border-b border-slate-300 dark:border-slate-700"><span
                                                    class="hidden md:block">Ступень</span>
                                            </th>
                        ...
                        <div>
                            ...
                            <div class="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/50 p-2 sm:p-4 rounded-xl mb-4">
                                ...
                                <p class="mb-4 text-xs md:text-sm text-slate-600 dark:text-slate-400">
                                    ...
                                    начислена амортизация в размере <strong class="underline">40 000 ₽</strong>. Оборудование продано стороннему лицу за
                                    ...
                                    <div>
                                        ...
                                        <ul class="space-y-3 text-xs md:text-sm text-slate-600 dark:text-slate-400">
                                            ...
                                            <li class="flex items-start gap-2">
                                                <span class="text-indigo-500 font-bold mt-0.5">•</span>
                                                <div>
                                                    <strong class="text-slate-800 dark:text-slate-200">Акт о приеме-передаче основных средств (<a
                                                            target="_blank"
