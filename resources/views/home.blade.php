<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto px-2 sm:px-6 lg:px-8 py-8 space-y-8 lg:space-y-12">
        <div class="max-w-sm lg:max-w-xl mx-auto mt-4 md:mt-8">
        ...
        <div class="grid gap-4 sm:gap-6 grid-cols-1 md:grid-cols-3">
            ...
            <div class="bg-white dark:bg-gray-900 p-6 md:p-7 rounded-xl shadow-lg">
                ...
                <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-2 md:mt-3">{{ __('A unique metric for the level of trust a company can earn or lose') }}</div>
        ...
        <div class="max-w-xl lg:max-w-2xl mx-auto mt-4">
        ...
        <div class="bg-white dark:bg-gray-900 p-6 md:p-7 rounded-2xl shadow-lg space-y-4">
            <div class="flex items-center">
                <div class="me-3 sm:me-4 flex items-center justify-center text-xs sm:text-lg text-white bg-[#40ff9f]/80 shadow-md min-w-5 h-5 sm:min-w-8 sm:h-8 rounded-full">✓</div>
                <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('Registration of individual entrepreneur or LLC') }}</div>
            </div>
            <div class="flex items-center">
                <div class="me-3 sm:me-4 flex items-center justify-center text-xs sm:text-lg text-white bg-[#40ff9f]/80 shadow-md min-w-5 h-5 sm:min-w-8 sm:h-8 rounded-full">✓</div>
                <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('Duration of work since company registration') }}</div>
            </div>
            <div class="flex items-center">
                <div class="me-3 sm:me-4 flex items-center justify-center text-xs sm:text-lg text-white bg-[#40ff9f]/80 shadow-md min-w-5 h-5 sm:min-w-8 sm:h-8 rounded-full">✓</div>
                <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('Number of offices and points of sale') }}</div>
            </div>
            <div class="flex items-center">
                <div class="me-3 sm:me-4 flex items-center justify-center text-xs sm:text-lg text-white bg-[#40ff9f]/80 shadow-md min-w-5 h-5 sm:min-w-8 sm:h-8 rounded-full">✓</div>
                <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('Official income of the company') }}</div>
            </div>
            <div class="flex items-center">
                <div class="me-3 sm:me-4 flex items-center justify-center text-xs sm:text-lg text-white bg-[#40ff9f]/80 shadow-md min-w-5 h-5 sm:min-w-8 sm:h-8 rounded-full">✓</div>
                <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('Registered employees') }}</div>
            </div>
            <div class="flex items-center">
                <div class="me-3 sm:me-4 flex items-center justify-center text-xs sm:text-lg text-white bg-[#40ff9f]/80 shadow-md min-w-5 h-5 sm:min-w-8 sm:h-8 rounded-full">✓</div>
                <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('Uniqueness of content and contracts') }}</div>
            </div>
            <div class="flex items-center">
                <div class="me-3 sm:me-4 flex items-center justify-center text-xs sm:text-lg text-white bg-[#40ff9f]/80 shadow-md min-w-5 h-5 sm:min-w-8 sm:h-8 rounded-full">✓</div>
                <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('Participation in conferences and mention in the media') }}</div>
            </div>
            <div class="flex items-center">
                <div class="me-3 sm:me-4 flex items-center justify-center text-xs sm:text-lg text-white bg-[#40ff9f]/80 shadow-md min-w-5 h-5 sm:min-w-8 sm:h-8 rounded-full">✓</div>
                <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('Message response speed') }}</div>
            </div>
            <div class="flex items-center">
                <div class="me-3 sm:me-4 flex items-center justify-center text-xs sm:text-lg text-white bg-[#40ff9f]/80 shadow-md min-w-5 h-5 sm:min-w-8 sm:h-8 rounded-full">✓</div>
                <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('Reviews') }}</div>
            </div>
        </div>
