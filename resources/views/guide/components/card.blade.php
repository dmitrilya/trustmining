<div class="relative sm:max-w-md h-full bg-white/60 dark:bg-zinc-900/60 shadow-md shadow-logo-color overflow-hidden rounded-lg flex flex-col justify-between">
    <div>
    ...
    <div class="p-2 md:p-3 mt-1 xs:mt-2">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                <svg class="w-3 h-3 xs:w-4 xs:h-4 text-gray-700 dark:text-white" aria-hidden="true" height="24" fill="currentColor"
                    viewBox="0 0 24 24">
