<x-app-layout :title="$guide->title" :description="$guide->subtitle">
    ...
    <div class="max-w-4xl mx-auto px-2 sm:px-6 lg:px-8 py-8">
        <div
            class="bg-white dark:bg-zinc-900 text-gray-800 dark:text-gray-300 overflow-hidden shadow-sm dark:shadow-zinc-800 rounded-lg p-2 sm:p-4 md:p-6 mb-6 space-y-4 sm:space-y-6 lg:space-y-8">
